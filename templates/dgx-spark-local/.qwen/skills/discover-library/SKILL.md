...
Newly installed skills are visible to the agent on the NEXT turn via the `skill` tool. To use them in the SAME turn (e.g. mid-build), `read_file` the relevant SKILL.md directly from `.qwen/skills/<name>/<skill-dir>/SKILL.md`.
