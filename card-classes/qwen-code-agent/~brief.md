...
When asked to build a new **type** of card, use the `create-card-class` skill. It covers the full workflow — understanding requirements, updating canvas cards, and building the card as a standard HTML file.
