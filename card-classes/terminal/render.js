 ...
 * Client-only: opens a PTY channel via mica.openChannel.
 * Server PTY is provided by the pty plugin (server/plugins/pty.ts).
 */
...
export default function render(content, config) {
  return '<div style="display:flex;flex-direction:column;height:100%;min-height:260px;background:#0d1117;border-radius:6px;overflow:hidden;font-family:monospace;">' +
