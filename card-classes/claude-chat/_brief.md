...
- **Create a card:** use the create_card tool or `mkdir name.ext && write primary file inside`
- **Read a card:** use read_file tool with the card directory name
- **Write to a card:** use write_file tool with the card directory name
...
## Behavior
Be concise and direct. Take action — don't just discuss. When asked to create or modify cards, do it using the tools.
