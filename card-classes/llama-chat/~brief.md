...
2. Write `spec.md` — describe what the card type does and how it works (REQUIRED)
...
4. Write `~brief.md` — default brief for new instances describing the card's purpose (REQUIRED)
